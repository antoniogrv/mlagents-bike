...
public class SpawnPerson : MonoBehaviour
{
    ...
    void SpawnObjectOnPlane(GameObject plane)
    {
        ...
        // Puoi impostare altre propriet� del collider se necessario
        ...
        // Ad esempio, puoi spostare il collider in alto di 0.5 unit� rispetto al centro dell'oggetto
    ...
    IEnumerator CasualWaiting(GameObject plane)
    {
        ...
        // Questo codice verr� eseguito dopo l'attesa casuale
